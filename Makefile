...
CPPFLAGS := -nostdinc -D_LANGUAGE_C -DMIPS -DF3DEX_GBI_2 -DF3DEX_GBI_PL -DGBI_DOWHILE -I include -I include/dummy_headers \
				-I"$(MM_DECOMP_DIR)/include" -I"$(MM_DECOMP_DIR)/src" -I"$(MM_DECOMP_DIR)/assets" -I"$(MM_DECOMP_DIR)/extracted/n64-us" -I"$(MM_DECOMP_DIR)/include/libc"
